...
namespace GHPITestExtension
{
    ...
    class GreetingsOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public override IAcisSMEOperationGroup OperationGroup { get => new GHPITestOperationGroup(); }
        ...
        {
            String returnMessage = "Hello World Shivangi";
